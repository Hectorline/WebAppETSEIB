...
def matriculats(assig,quadri,an,sex):
    """
    retorna el nombre de matriculats per a un aassignatura, quadrimestre, any, si no s'introdueix el sexe, retorna els dos
    """
...
def aprovats(assig,quadri,an,sex):
    """
    retorna el nombre d'aprovats per assignatura, quadrimestre i any. si no s'introdueix el paràmetre sex retorna ambdos sexes
    """
    f1 = open('NouFitxer.csv','r')
    c = 0
    for linea in f1:
